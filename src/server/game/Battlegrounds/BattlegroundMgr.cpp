...
//  uint64 const scheduleId = ((uint64)arenaMatchmakerRating << 32) | (uint32(arenaType) << 24) | (bgQueueTypeId << 16) | (bgTypeId << 8) | bracket_id;
	uint64 const scheduleId = ((uint64)arenaMatchmakerRating << 32) | (arenaType << 24) | (bgQueueTypeId << 16) | (bgTypeId << 8) | (dynamicMMRindex << 4) | bracket_id;
                                                                ...
                                                                if ((*itr)->DynamicMMRindex < 6)
                                                                {
                                                                        ...
                                                                        if (ArenaTeam* team = sArenaTeamMgr->GetArenaTeamById((*itr)->ArenaTeamId))
                                                                        {
                                                                                for (ArenaTeam::MemberList::iterator iter = team->m_membersBegin(); iter != team->m_membersEnd(); iter++)
                                                                                {
                                                                                        ...
                                                                                        {
                                                                                                ChatHandler(plr->GetSession()).PSendSysMessage("Your MMR Range has increased! MMR diff is between %u MMR - %u MMR", (*itr)->ArenaMatchmakerRating - (600 + GetMaxRatingDifference()), (*itr)->ArenaMatchmakerRating + (600 + GetMaxRatingDifference()));
                                                                                        }
                                                                                }
                                                                        }
                                                                }
                                                                ...
                                                                if ((*itr)->DynamicMMRindex < 5)
                                                                {
                                                                        ...
                                                                        if (ArenaTeam* team = sArenaTeamMgr->GetArenaTeamById((*itr)->ArenaTeamId))
                                                                        {
                                                                                for (ArenaTeam::MemberList::iterator iter = team->m_membersBegin(); iter != team->m_membersEnd(); iter++)
                                                                                {
                                                                                        if (Player* plr = sObjectAccessor->FindPlayer(iter->Guid))
                                                                                        {
                                                                                                ChatHandler(plr->GetSession()).PSendSysMessage("Your MMR Range has increased! MMR diff is between %u MMR - %u MMR", (*itr)->ArenaMatchmakerRating - (500 + GetMaxRatingDifference()), (*itr)->ArenaMatchmakerRating + (500 + GetMaxRatingDifference()));
                                                                                        }
                                                                                }
                                                                        }
                                                                }
                                                                ...
                                                                if ((*itr)->DynamicMMRindex < 4)
                                                                {
                                                                        ...
                                                                        if (ArenaTeam* team = sArenaTeamMgr->GetArenaTeamById((*itr)->ArenaTeamId))
                                                                        {
                                                                                for (ArenaTeam::MemberList::iterator iter = team->m_membersBegin(); iter != team->m_membersEnd(); iter++)
                                                                                {
                                                                                        if (Player* plr = sObjectAccessor->FindPlayer(iter->Guid))
                                                                                        {
                                                                                                ChatHandler(plr->GetSession()).PSendSysMessage("Your MMR Range has increased! MMR diff is between %u MMR - %u MMR", (*itr)->ArenaMatchmakerRating - (400 + GetMaxRatingDifference()), (*itr)->ArenaMatchmakerRating + (400 + GetMaxRatingDifference()));
                                                                                        }
                                                                                }
                                                                        }
                                                                }
                                                                ...
                                                                if ((*itr)->DynamicMMRindex < 3)
                                                                {
                                                                        ...
                                                                        if (ArenaTeam* team = sArenaTeamMgr->GetArenaTeamById((*itr)->ArenaTeamId))
                                                                        {
                                                                                for (ArenaTeam::MemberList::iterator iter = team->m_membersBegin(); iter != team->m_membersEnd(); iter++)
                                                                                {
                                                                                        if (Player* plr = sObjectAccessor->FindPlayer(iter->Guid))
                                                                                        {
                                                                                                ChatHandler(plr->GetSession()).PSendSysMessage("Your MMR Range has increased! MMR diff is between %u MMR - %u MMRR", (*itr)->ArenaMatchmakerRating - (300 + GetMaxRatingDifference()), (*itr)->ArenaMatchmakerRating + (300 + GetMaxRatingDifference()));
                                                                                        }
                                                                                }
                                                                        }
                                                                }
                                                                ...
                                                                if ((*itr)->DynamicMMRindex < 2)
                                                                {
                                                                        ...
                                                                        if (ArenaTeam* team = sArenaTeamMgr->GetArenaTeamById((*itr)->ArenaTeamId))
                                                                        {
                                                                                for (ArenaTeam::MemberList::iterator iter = team->m_membersBegin(); iter != team->m_membersEnd(); iter++)
                                                                                {
                                                                                        if (Player* plr = sObjectAccessor->FindPlayer(iter->Guid))
                                                                                        {
                                                                                                ChatHandler(plr->GetSession()).PSendSysMessage("Your MMR Range has increased! MMR diff is between %u MMR - %u MMR", (*itr)->ArenaMatchmakerRating - (200 + GetMaxRatingDifference()), (*itr)->ArenaMatchmakerRating + (200 + GetMaxRatingDifference()));
                                                                                        }
                                                                                }
                                                                        }
                                                                }
                                                                ...
                                                                if ((*itr)->DynamicMMRindex < 1)
                                                                {
                                                                        ...
                                                                        if (ArenaTeam* team = sArenaTeamMgr->GetArenaTeamById((*itr)->ArenaTeamId))
                                                                        {
                                                                                for (ArenaTeam::MemberList::iterator iter = team->m_membersBegin(); iter != team->m_membersEnd(); iter++)
                                                                                {
                                                                                        if (Player* plr = sObjectAccessor->FindPlayer(iter->Guid))
                                                                                        {
                                                                                                ChatHandler(plr->GetSession()).PSendSysMessage("Your MMR Range has increased! MMR diff is between %u MMR - %u MMR", (*itr)->ArenaMatchmakerRating - (100 + GetMaxRatingDifference()), (*itr)->ArenaMatchmakerRating + (100 + GetMaxRatingDifference()));
                                                                                        }
                                                                                }
                                                                        }
                                                                }
